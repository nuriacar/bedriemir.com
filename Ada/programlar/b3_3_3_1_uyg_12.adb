...
begin
    ...
    Ada.Float_Text_IO.Put(Item => Float'Machine_Rounding(Gerçek_Sayý) , Fore => 2 , Aft => 2 , Exp => 0);
    
    Ada.Text_IO.Put(Item => "      (Yuvarlatma Metodu Machine_Rounding)");
